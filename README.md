...
This code repository is an attachment for the IGARSS 2023 proceeding paper: Paluba D. et al. (2023): "Unsupervised Burned Area Mapping in Greece: Investigating the imapct of precipitation, pre- and pre-processing of Sentinel-1 data in Google Earth Engine". (under review process)
